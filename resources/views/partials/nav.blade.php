<div class="top-bar">
    <div class="top-bar__container">
        <div class="top-bar__left">
            <a href="tel:+48 500 638 676" class="top-bar__link"
                ><svg
                ...
                +48 500 638 676</a
            >
            <a href="mailto:biuro@ksero-k2system.pl" class="top-bar__link"
                ><svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 -960 960 960"
                    class="top-bar__icon"
        ...
        <div class="top-bar__right">
            <span class="top-bar__text"
                ...
                Spółdzielcza 2, 43-400 Cieszyn</span
            >
        </div>
    </div>
</div>
    ...
    <div class="desktop-nav__wrapper">
            ...
            <div class="desktop-nav__top-container">
                ...
                <div class="desktop-nav__search">
                    ...
                    <button class="desktop-nav__search-button">
                        ...
                        <svg
                            ...
                            height="24px"
                            viewBox="0 -960 960 960"
                            class="desktop-nav__search-icon"
                        >
                            <path
                ...
                <div class="desktop-nav__buttons">
                    <a href="#" class="desktop-nav__button-wrapper">
                        ...
                        <div class="desktop-nav__text">
                            <span class="desktop-nav__title">Konto</span>
        ...
        <div class="desktop-nav__bottom">
            <div class="desktop-nav__bottom-container">
                ...
                <a href="#" class="desktop-nav__button">Darmowa konsultacja</a>
            </div>
        </div>
    </div>
</nav>
